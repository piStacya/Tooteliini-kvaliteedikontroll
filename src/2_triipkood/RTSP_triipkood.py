...
# ─── TOOTEANDMEBAAS ─────────────────────────────────────────────────────────
data_path = os.path.join(_PROJECT_ROOT, "config", "barcode_data.json")
...
folder_name = os.path.join(_PROJECT_ROOT, "andmed", stream_name)
...
try:
    ...
    if change_log:
        ...
        plt.legend()
        plt.tight_layout()
        graf_path = os.path.join(folder_name, f"liikumise_graafik_{stream_name}.png")
